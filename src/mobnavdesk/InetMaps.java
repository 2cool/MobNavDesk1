...
class GoogleMap implements INET_MAPS{
	...
	public String getExt(){return png;}
	public Image getIcon(){return null;}//MyI.googleIcon;}
	public String getUrl(final int x,final int y,final int z){
		cnt++;
...
class MicrosoftEarthAndLabels implements INET_MAPS{
	...
	public String getExt(){return jpg;}
	public Image getIcon(){return null;}// MyI.bingIcon;}
...
class TopoKrym implements INET_MAPS{
	...
	public String getExt(){return jpg;}
	public Image getIcon(){return null;}// MyI.openStreetIcon;}
	public String getUrl(final int x,final int y,final int z){
		cnt++;
...
class YahooMap implements INET_MAPS{
	...
	public String getExt(){return png;}
	public Image getIcon(){return null;}// MyI.yahooIcon;}
	public String getUrl(final int x,final int y,final int z){
		cnt++;
		int s;
		if (z>1){
...
public byte[] downLoadTile(int x, int y, int z){	
...
static public String getTileFName(final int type, final int x, final int y, final int z){
     File fc; 
    try {
        try{             
...
*/
public String getTileFName(final int x, final int y, final int z){
...
public boolean tileExistOrLoad(final int x, int y, final int z){
